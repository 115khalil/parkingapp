...
class _HomePageState extends State<HomePage> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          premp = data['luxp'];
          handp = data['hadp'];
          ecoAvailable = selectedLocation == "Sfax–Thyna International Airport"
              ? data['sfaxcapeco']
              : data['djcapeco'];
          luxAvailable = selectedLocation == "Sfax–Thyna International Airport"
              ? data['sfaxcaplux']
              : data['djcaplux'];
          handAvailable = selectedLocation == "Sfax–Thyna International Airport"
              ? data['sfaxcaphad']
              : data['djcaphad'];
        });
        _showAvailableSpotsDialog();
      } else {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Failed to fetch parking data."),
  ...
  void _showAvailableSpotsDialog() {
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(
                  'Economy Zone: $ecoAvailable spots',
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 16,
                  ),
                ...
                SizedBox(height: 10),
                Text(
                  'Premium Zone: $luxAvailable spots',
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 16,
                  ),
                ...
                SizedBox(height: 10),
                Text(
                  'Handicap Zone: $handAvailable spots',
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 16,
                  ),
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            color: Color.fromARGB(255, 149, 148, 150),
                            width: 1.0),
                      ),
